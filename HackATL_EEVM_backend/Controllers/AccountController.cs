...
namespace HackATL_EEVM_backend.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Username,PasswordHash,PasswordSalt,Token,Role")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Username,PasswordHash,PasswordSalt,Token,Role")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
